    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <div className={`fixed inset-0 bg-white z-50 flex items-center justify-center transition-opacity duration-1000 ${
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="text-xl font-semibold text-gray-700 animate-pulse">Loading Manager Panel...</div>
        </div>
      </div>
            ...
            <div className="flex items-center space-x-6">
              <div className="hidden md:flex items-center space-x-4">
                <div className="text-right">
                  <p className="text-sm font-semibold text-gray-900">Manager User</p>
                  <p className="text-xs text-gray-500">manager@stockmate.com</p>
                </div>
                <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
                  <span className="text-white font-semibold text-sm">MU</span>
                </div>
              </div>
        ...
        <div className={`mb-8 transition-all duration-1000 ${
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white shadow-2xl">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-4xl font-bold mb-2">Welcome back, Manager!</h2>
                <p className="text-blue-100 text-lg">Manage your inventory system efficiently with our comprehensive management tools.</p>
              </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 group hover:scale-105">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-blue-600 font-medium mt-1">+2 new this month</p>
              </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 group hover:scale-105">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold text-gray-900">${stats.monthlyRevenue.toLocaleString()}</p>
                <p className="text-xs text-green-600 font-medium mt-1">+8.5% from last month</p>
              </div>
        ...
        {managerFeatures.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-blue-400 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all duration-500`}></div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center text-blue-600 font-semibold group-hover:text-blue-700 transition-colors duration-300 text-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-6 p-6 bg-gradient-to-r from-green-50 to-green-100 rounded-xl border border-green-200">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">John Doe joined the system as a new supplier</p>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex items-center space-x-6 p-6 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                  <div className="w-4 h-4 bg-purple-500 rounded-full"></div>
                  <div className="flex-1">
                    <p className="text-lg font-semibold text-gray-900">Monthly report generated</p>
                    <p className="text-sm text-gray-600">December 2024 inventory report is ready for review</p>
                  </div>
                  <div className="text-right">
